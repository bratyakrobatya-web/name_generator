...
<div class="fixed-panel">
    <div class="panel-inner">
        <div class="panel-row">
            ...
            {"<button id='btnNaming' class='copy-btn copy-btn-green' data-text='" + html.escape(preview, quote=True) + "' onclick='copyToClipboard(this)'>📋 Копировать</button>" if preview else "<div class='copy-btn copy-btn-disabled'>📋 Копировать</div>"}
        </div>
        <div class="panel-row">
            <span class="panel-label">UTM:</span>
            <code class="panel-code" style="color:{utm_color};">{utm_display}</code>
            {"<button id='btnUtm' class='copy-btn copy-btn-blue' data-text='" + html.escape(utm_preview, quote=True) + "' onclick='copyToClipboard(this)'>📋 Копировать</button>" if utm_preview else "<div class='copy-btn copy-btn-disabled'>📋 Копировать</div>"}
        </div>
    </div>
</div>
''', unsafe_allow_html=True)
